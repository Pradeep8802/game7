...
if((inside(blocksArray[i][0],blocksArray[i][1],blocksSizeArray[i][0],blocksSizeArray[i][1],j))
&& (inside(blocksArray[i][0]+blocksSizeArray[i][0],blocksArray[i][1],blocksSizeArray[i][0],blocksSizeArray[i][1],j))
&&
(inside(blocksArray[i][0],blocksArray[i][1]+blocksSizeArray[i][1],blocksSizeArray[i][0],blocksSizeArray[i][1],j))
&& (inside(blocksArray[i][0]+blocksSizeArray[i][0],blocksArray[i][1]+blocksSizeArray[i][1],blocksSizeArray[i][0],blocksSizeArray[i][1],j))){
    //console.log("hello");
    return true;
}
else {return false;}}

function inside(x,y,w,h,j){
if(((x>blocksArray[j][0]) && (x<blocksArray[j][0]+w*SIZEOFBLOCK))&&(y>blocksArray[j][1]) && (y<blocksArray[j][1]+h*SIZEOFBLOCK)){
    return true;
    }
    return false;
}
